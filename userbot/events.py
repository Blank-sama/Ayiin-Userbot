...
from Bonten import CMD_HANDLER, CMD_LIST, DEFAULT, DEVS, bot


def Bonten_cmd(pattern=None, command=None, **args):
        ...
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    text = "**✘ Bonten-Bonten ERROR REPORT ✘**\n\n"
                    link = "[Group Support](https://t.me/BontenXdSupport)"
                    ...
                    ftext += "\ncukup forward saja pesan ini ke @BontenXdSupport"
                    ftext += "\n================================\n\n"
                    ftext += "--------BEGIN Bonten TRACEBACK LOG--------\n"
                    ftext += "\nTanggal : " + date
